...
const MESSAGE_KEYS = [
  ...
  "Phrases.title",
  "Phrases.loading",
  "Phrases.empty.heading",
  "Phrases.empty.body",
  "Phrases.empty.action",
  "Phrases.noMatches.heading",
  "Phrases.noMatches.body",
  "Phrases.clearFilters",
  "Phrases.filters",
  "Phrases.order.label",
  "Phrases.order.newest",
  "Phrases.order.review",
  "Phrases.reviewed.markButton",
  "Phrases.reviewed.never",
  "Phrases.reviewed.lastReviewed",
  "Phrases.export",
  "Phrases.import",
  "Phrases.importError",
  "Phrases.flagged.heading",
  "Phrases.flagged.topicIds",
  "Phrases.flagged.seedIds",
  "Phrases.all",
  "Phrases.category.label",
  "Phrases.category.travel",
  "Phrases.category.food",
  "Phrases.category.work",
  "Phrases.category.hobbies",
  "Phrases.category.technology",
  "Phrases.category.city-life",
  "Phrases.category.relationships",
  "Phrases.category.learning",
  "Phrases.structure.label",
  "Phrases.structure.prep",
  "Phrases.structure.concession",
  "Phrases.structure.comparison",
  "Phrases.mode.label",
  "Phrases.mode.short",
  "Phrases.mode.long",
  "Phrases.level",
  "Phrases.usedSeed.label",
  "Phrases.usedSeed.yes",
  "Phrases.usedSeed.no",
  "Phrases.delete",
  "Drill.title",
  "Drill.loading",
  "Drill.progress",
  "Drill.structureLabel",
  "Drill.mode.short",
  "Drill.mode.long",
  "Drill.answerLabel",
  "Drill.answerHint",
  "Drill.characterCount",
  "Drill.send",
  "Drill.sending",
  "Drill.busy",
  "Drill.cancel",
  ...
  "Drill.seeds.heading",
  "Drill.seeds.stance",
  "Drill.seeds.keyPhrases",
  "Drill.validation.empty",
  "Drill.validation.tooLong",
  "Drill.validation.notEnglish",
  "Drill.errors.ERR_BAD_REQUEST",
  "Drill.errors.ERR_ANSWER_TOO_LONG",
  "Drill.errors.ERR_ANSWER_NOT_ENGLISH",
  "Drill.errors.ERR_FORBIDDEN_ORIGIN",
  "Drill.errors.ERR_PAYLOAD_TOO_LARGE",
  "Drill.errors.ERR_LLM_AUTH",
  "Drill.errors.ERR_LLM_RATE_LIMIT",
  "Drill.errors.ERR_LLM_TIMEOUT",
  "Drill.errors.ERR_LLM_INVALID_OUTPUT",
  "Drill.errors.ERR_LLM_UNAVAILABLE",
  "Drill.errors.unknown",
  "Drill.errors.terminalHeading",
  "Drill.feedback.heading",
  "Drill.feedback.structureHeading",
  "Drill.feedback.fixesHeading",
  "Drill.feedback.noFixes",
  "Drill.feedback.rewriteHeading",
  "Drill.feedback.editRewriteLabel",
  "Drill.feedback.savePhrase",
  "Drill.feedback.savedToPhrases",
  "Drill.feedback.dismissSaved",
  "Drill.feedback.grammarHeading",
  "Drill.feedback.noGrammar",
  "Drill.element.point",
  "Drill.element.reason",
  "Drill.element.example",
  "Drill.element.restatement",
  "Drill.element.acknowledgement",
  "Drill.element.opinion",
  "Drill.element.contrast",
  "Drill.element.choice",
  "Drill.verdict.present",
  "Drill.verdict.weak",
  "Drill.verdict.absent",
  "Drill.complete.heading",
  "Drill.complete.body",
  "Drill.complete.restart",
  "Drill.complete.homeLink",
